...
public class TodasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        receitas= todosAsReceitas();
        receitas = new ArrayList<>(Arrays.asList(SortAlfabetic(receitas)));
    ...
    private ArrayList<Receita> todosAsReceitas() {
    ...
    private void getRepoList() {
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                // Create URL
                try {
                    URL githubEndpoint = new URL(baseUrl + "/" + "users");
        ...
        Toast.makeText(TodasActivity.this, "deu", Toast.LENGTH_SHORT).show();
    }
